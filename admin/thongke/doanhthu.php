<div class="products">
    ...
    <form action="your_script.php" method="post">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            // Gọi hàm để thống kê doanh thu theo tháng và năm được chọn
            $rows = doanhthutheothang($selected_month, $selected_year);
        
            // Tiếp tục xử lý và hiển thị dữ liệu theo kết quả thống kê
        }
