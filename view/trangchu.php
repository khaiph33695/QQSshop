...
<div class="slideshow-container">
    ...
    <div class="mySlides fade">
        <img src="./img/banner.webp" style="width:100%">
    </div>

    <div class="mySlides fade">
        <img src="./img/banner10.jpg" style="width:100%">
    </div>

    <div class="mySlides fade">
        <img src="./img/banner 12.jpg" style="width:100%">
    </div>
...
<div class="danhmuc">
    <?php
    $img = ['img/dm/leonui.avif', 'img/dm/chaybo.webp', 'img/dm/bongda.jpg'];
    $i = 0;
    foreach ($dsdm as $dm) {
