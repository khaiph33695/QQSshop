...
<body>
    ...
    <header>
        <div class="logo">
            <a href="index.php"><img src="img/logogiay2.jpg" alt=""></a>
        </div>
    ...
    <nav class="menu">
        <ul>
            ...
            <li><a href="index.php?act=sanpham&iddm=4">Giày bóng đá</a></li>
            <li><a href="index.php?act=sanpham&iddm=5">Giày chạy bộ</a></li>
            <li><a href="index.php?act=sanpham&iddm=6">Giày leo núi</a></li>
